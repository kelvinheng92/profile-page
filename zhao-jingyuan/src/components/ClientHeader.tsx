        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          ...
          <div className="flex items-start gap-5">
            ...
            <div className="w-20 h-20 rounded-full overflow-hidden shrink-0 shadow-lg border-2 border-white/30">
              <Image
                src="/zhao-jingyuan.jpg"
                alt="Dr Zhao Jingyuan"
                width={80}
                height={80}
            ...
            <div>
              ...
              <p className="text-white/70 mt-0.5 text-sm font-medium">{client.title}</p>
              <div className="flex items-center gap-2 mt-1">
                <Building2 className="w-3.5 h-3.5 text-[#C8102E]" />
                <span className="text-white/60 text-xs">{client.employer}</span>
              </div>
              <div className="flex flex-wrap gap-2 mt-3">
                <span className="bg-[#C8102E] text-white text-xs font-semibold px-3 py-1 rounded-full">
          ...
          {/* Right: quick facts */}
          <div className="grid grid-cols-2 gap-3 md:text-right text-xs text-white/70">
            <div className="flex items-center gap-2">
              <GraduationCap className="w-4 h-4 text-[#C8102E] shrink-0" />
              <span>PhD Statistics, NUS</span>
            </div>
            <div className="flex items-center gap-2">
              <Globe className="w-4 h-4 text-[#C8102E] shrink-0" />
              <span>{client.nationality}</span>
            </div>
            <div className="flex items-center gap-2">
              <Award className="w-4 h-4 text-[#C8102E] shrink-0" />
              <span>SG 100 Women in Tech (2021)</span>
            </div>
            <div className="flex items-center gap-2">
